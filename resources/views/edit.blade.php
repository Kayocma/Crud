            ...
            <div class="row justify-content-center">
                <div class="col-sm-8">
                    <div class="card mt-3 p-3">
                        <h3 class="text-muted">Atualização do(a) Cliente {{ $cliente->nome }}</h3>
                        <form method="POST" action="{{ route('clientes.update', $cliente->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label>CPF ou CNPJ: </label>
                                <input type="text" name="cpf_cnpj" class="form-control" value="{{ old('cpf_cnpj', $cliente->cpf_cnpj) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nome_social" class="form-control" value="{{ old('nome_social', $cliente->nome_social) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="data_nascimento" class="form-control" value="{{ old('data_nascimento', $cliente->data_nascimento) }}">
